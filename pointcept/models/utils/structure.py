...
from .ring_cyl import ring_cyl_rank_encode
...
class Point(Dict):
    ...
    #     for order_ in order:
    #         if order_ == "ring-cyl":
    #             code_ = ring_cyl_rank_encode(
    #                 self.grid_coord,
    #                 batch=self.batch,
    #                 gr=self.get("ring_cyl_gr", 1),
    #                 gz=self.get("ring_cyl_gz", 8),
    #                 theta_offset_deg=self.get("ring_cyl_theta_offset_deg", 0.0),
    #                 center_mode=self.get("ring_cyl_center_mode", "bbox"),
    #             )
    #         else:
    #             code_ = encode(self.grid_coord, self.batch, depth, order=order_)
    #         code.append(code_)
